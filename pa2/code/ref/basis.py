...
if __name__ == '__main__':
    ...
    parser.add_argument('--N', type=int, default=1, help='Number of control points')
    parser.add_argument('--k', type=int, default=2, help='Spline order x^k')
    parser.add_argument('--bspline', default='True',action='store_true', help='Draw B-Spline instead of Bezier')
